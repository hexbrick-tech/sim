...
| 巻 | タイトル | 役割 |
| --- | --- | --- |
| Prologue | **SIMの起源と位置付け** | SIMがなぜ存在するのか、哲学・原理・方法がどのように関係するのかを示す |
| Vol. 1 | **Meta-Observationalism — メタ観測主義論** | 哲学的基盤 |
| Vol. 2 | **Reflexive Observation Principle — 再起観測原理** | 対象と観測行為そのものをともに観測する原理 |
